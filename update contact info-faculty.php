...
if (!empty($_POST['save'])) {
    ...
    $stmt = $con->prepare("UPDATE faculty SET email=?, mobile_number=?, fb_profile_link=? WHERE userID=?");
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="STYLES/update contact info-faculty.css">
