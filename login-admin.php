<?php
	...
	if(isset($_POST['submit'])){
		...
		$result = mysqli_query($con, "SELECT * FROM admin WHERE admin_id='$admin_id' AND
								password='$password'");
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="STYLES/login-admin.css">
	<title></title>
...
<center>
	...
	<div class="container">
		...
		<form placeholder="Select" action = "" method = "post">
			...
			<div class="input1">
				<input type="text" id="userID" name="admin_id" placeholder="User ID" required>
			</div>
			<div class="key-box">
