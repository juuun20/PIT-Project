<?php
	...
	if(isset($_POST['submit'])){
		...
		$result = mysqli_query($con, "SELECT * FROM faculty WHERE faculty_id='$faculty_id' AND
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="STYLES/login-faculty.css">
	<title></title>
	<link rel="stylesheet" 
...
<center>
	...
	<div class="container">
		...
		<form placeholder="Select" action = "" method ="post">
			...
			<div class="input1">
				<input type="text" id="userID" name="faculty_id" placeholder="User ID" required>
			</div>
