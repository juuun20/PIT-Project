<?php
	...
	if(isset($_POST['submit'])){
		...
		$result = mysqli_query($con, "SELECT * FROM student WHERE student_id='$student_id' AND
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="STYLES/login-student.css">
	<title></title>
...
<center>
	...
	<div class="container">
		...
		<form placeholder="Select" action="" method="post">
			...
			<div class="input1">
				<input type="text" id="userID" name="student_id" placeholder="Student Id" required>
			</div>
