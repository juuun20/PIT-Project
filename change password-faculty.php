...
if(!empty($_POST['save'])) {
    ...
    if($p2 == $p3) {
        ...
        $stmt = $con->prepare("SELECT * FROM faculty WHERE password=?");
        ...
        if($count > 0) {
            ...
            $stmt = $con->prepare("UPDATE faculty SET password=? WHERE password=?");
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="STYLES/change password-faculty.css">
...
<body>
  <nav class="navbar">
    <div class="navdiv">
      ...
      <ul>
        <li><a href="notification-faculty.php"><i class="fa-solid fa-bell"></i> NOTIFICATIONS</a></li>
        <li><a href="home-faculty.php"><i class="fa-solid fa-house"></i> HOME</a></li>
        <li><a href="clearance-faculty.php"><i class="fa-solid fa-folder"></i> CLEARANCE</a></li>
        <li>
          <a href="#"><i class="fa-solid fa-user"></i> USERS ˅</a>
          <ul class="dropdown">
            <li><a href="update contact info-faculty.php">UPDATE CONTACT INFO</a></li>
            <li><a href="change password-faculty.php">CHANGE PASSWORD</a></li>
